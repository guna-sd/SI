...
def top_p_logits(logits, threshold):
...
def generate_text(model, length, start_token=None, batch_size=None, context=None, temperature=0.9, top_k=50, top_p=0.9, device='cuda', sample=True):
